...
export default function Introduction() {
    ...
    return (
      <div>
      <section className="w-full py-6 sm:py-6 md:py-12 lg:py-18 xl:py-24 bg-milk group" id="introduction-container">
        ...
        <div className="w-full py-12 lg:py-16 bg-timeline bg-no-repeat bg-bottom bg-cover">
          <div className="container grid items-center justify-center gap-8 px-4 text-center md:px-6">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-white" data-aos="fade-right">How we do it</h2>
              <p className="mx-auto max-w-xl text-blue-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed font-extralight bg-slate-900" data-aos="fade-right">
                The key to unlocking simplified, high-quality content with ease.
              </p>
            </div>
            <div className="grid w-full grid-cols-1 items-center justify-center gap-10 md:grid-cols-3 md:gap-0 lg:gap-16">
              <div className="flex flex-col items-center justify-center space-y-2 bg-white rounded-2xl p-8 hover:bg-opacity-20 transition-all border group hover:scale-110 hover:shadow-xl">
                <div className="rounded-full border-4 border-white overflow-hidden w-16 h-16 group-hover:border-green-600" data-aos="fade-left">
                  <FaSpider className="bg-white rounded-full object-cover h-14 w-14"/>
                </div>
              ...
              <div className="flex flex-col items-center justify-center space-y-2 bg-white rounded-2xl p-8 hover:bg-opacity-20 transition-all border group hover:scale-110 hover:shadow-xl">
                <div className="rounded-full border-4 border-white overflow-hidden w-16 h-16 group-hover:border-yellow-400 group-hover" data-aos="fade-left" data-aos-delay="50">
                  <TbVectorBezier2 className="bg-white rounded-full object-cover h-14 w-14"/>
                </div>
                <h3 className="text-xl font-bold group-hover:text-white" data-aos="zoom-in" data-aos-delay="100">Vectorized Content</h3>
              ...
              <div className="flex flex-col items-center justify-center space-y-2 bg-white rounded-2xl p-8 hover:bg-opacity-20 transition-all border group hover:scale-110 hover:shadow-xl">
                <div className="rounded-full border-4 border-white overflow-hidden w-16 h-16 group-hover:border-blue-400" data-aos="fade-left" data-aos-delay="100">
                  <LuPackageSearch className="bg-white rounded-full object-cover h-14 w-14"/>
                </div>
