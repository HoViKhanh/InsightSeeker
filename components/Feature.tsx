...
export function Feature() {
  ...
  return (
    <section className="w-full py-12 bg-linen bg-opacity-30 dark:bg-zinc-950 dark:bg-opacity-55">
      <div className="container grid gap-8">
        <div className="space-y-2">
          <h2 className="text-3xl font-bold text-blue-900 dark:text-orange-500" data-aos="fade-left">Explore Our Features</h2>
