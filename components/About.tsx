    ...
    <section className="w-full py-8 md:py-16 lg:py-20 bg-about bg-no-repeat bg-cover">
      <div className="container flex flex-col items-center gap-4 px-4 md:px-6">
        <div className="text-center space-y-2">
          ...
          <p className="max-w-[700px] text-black italic md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed" data-aos="fade-up" data-aos-delay="50">
          ...
          <Link
            className="bg-slate-900 dark:bg-white inline-flex items-center justify-center rounded-md px-6 py-3 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:text-black  dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300 mt-4" 
            data-aos="fade-up"
            data-aos-delay="100"
            href="#"
          >
